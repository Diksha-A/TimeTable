...
$q = mysqli_query(mysqli_connect("localhost", "root", "", "ttms2"), "SELECT * FROM teachers ");
while ($row = mysqli_fetch_assoc($q)) {
    $query = mysqli_query(mysqli_connect("localhost", "root", "", "ttms2"), "SELECT * FROM " . $row['faculty_number'] . " WHERE day = '$day'");
