...
$q = mysqli_query(mysqli_connect("localhost", "root", "", "ttms2"), "INSERT INTO teachers VALUES ('$facno','$name','$alias','$designation','$contact','$email')");
...
mysqli_query(mysqli_connect("localhost", "root", "", "ttms2"), $sql);
